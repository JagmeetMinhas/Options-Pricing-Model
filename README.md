...
black_scholes.py: Implements the Black-Scholes model for European-style options.
monte_carlo.py: Uses Monte Carlo simulation to price options based on stochastic processes.
